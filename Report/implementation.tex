...
that we have seen before in Listing 1. % TODO faudrait-il les afficher de nouveau?? //Cédric: Non je pense pas, je fais juste référéence au listing, ca devrait faire le job.
...
\say{getFreshVar} return a new variable name with a suffix given as argument to make the temporary variable hold information of which expression it represents.
\newline
